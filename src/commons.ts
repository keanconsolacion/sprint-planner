...
export const avatarBaseURL = "/images/";
export const avatars = [
	`${avatarBaseURL}bear.png`,
	`${avatarBaseURL}cat.png`,
	`${avatarBaseURL}chicken.png`,
	`${avatarBaseURL}dog.png`,
	`${avatarBaseURL}dog-2.png`,
	`${avatarBaseURL}dragon.png`,
	`${avatarBaseURL}koala.png`,
	`${avatarBaseURL}meerkat.png`,
	`${avatarBaseURL}panda.png`,
	`${avatarBaseURL}rabbit.png`,
];
